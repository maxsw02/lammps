...
Atom::Atom(LAMMPS *_lmp) : Pointers(_lmp)
{
  ...
  rho = drho = esph = desph = cv = dentropy = nullptr;
  vest = nullptr;
  //Within SPH PACKAGE 
  entropy = nullptr;
  entropyest = nullptr;
...
void Atom::peratom_create()
{
  ...
  add_peratom("entropy",&entropy,DOUBLE,0);
  add_peratom("entropyest",&entropyest,DOUBLE,0);
  add_peratom("dentropy",&dentropy,DOUBLE,0,1);
...
void Atom::set_atomflag_defaults()
{
  ...
  dentropy_flag = entropy_flag = entropyest_flag = 0;
...
void *Atom::extract(const char *name)
{
  ...
  if (strcmp(name,"entropy") == 0) return (void *) entropy;
  if (strcmp(name,"entropyest") == 0) return (void *) entropyest;
  if (strcmp(name,"dentropy") == 0) return (void *) dentropy;
...
int Atom::extract_datatype(const char *name)
{
  ...
  if (strcmp(name,"entropy") == 0) return LAMMPS_DOUBLE;
  if (strcmp(name,"dentropy") == 0) return LAMMPS_DOUBLE;
  if (strcmp(name,"entropyest") == 0) return LAMMPS_DOUBLE;
